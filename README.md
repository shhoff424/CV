...
Currently, my research focuses on enhancing AI-driven frameworks by applying a **Graph-based Retrieval-Augmented Generation (GraphRAG)** technique to Large Language Models.
